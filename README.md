...
## 1. Построение новой модели данных

!['Схема данных'](img/001.png)
...
### gender - Пол
Для иностранцев будет оскорбительно, если не будет списка полов.
| Наименование поля | Тип поля | Комментарии
| --- | --- | --- |
